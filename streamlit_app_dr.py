...
def save_target_deployment_id(target_names,deployment_ids,directions):
    df = pd.DataFrame({'Target Name': target_names, 'Deployment ID': deployment_ids, 'Optimization Direction': directions})
    df.to_csv('config.csv',index=False)
    
    return df

def run_optimization(trials_num,df_feature,targets,deploy_ids,directions,feats_name,feats_value_min,feats_value_max):
    def objective(trial):
        ...
        if len(deploy_ids) == 14:
            ...
            return pred1,pred2,pred3,pred4,pred5,pred6,pred7,pred8,pred9,pred10,pred11,pred12,pred13,pred14
        ...
        if len(deploy_ids) == 15:
            ...
            return pred1,pred2,pred3,pred4,pred5,pred6,pred7,pred8,pred9,pred10,pred11,pred12,pred13,pred14,pred15 
        ...
        if len(deploy_ids) == 16:
            ...
            return pred1,pred2,pred3,pred4,pred5,pred6,pred7,pred8,pred9,pred10,pred11,pred12,pred13,pred14,pred15,pred16        
        if len(deploy_ids) == 17:
            ...
            return pred1,pred2,pred3,pred4,pred5,pred6,pred7,pred8,pred9,pred10,pred11,pred12,pred13,pred14,pred15,pred16,pred17 
        ...
        if len(deploy_ids) == 18:
            ...
            return pred1,pred2,pred3,pred4,pred5,pred6,pred7,pred8,pred9,pred10,pred11,pred12,pred13,pred14,pred15,pred16,pred17,pred18
        ...
        if len(deploy_ids) == 19:
            ...
            return pred1,pred2,pred3,pred4,pred5,pred6,pred7,pred8,pred9,pred10,pred11,pred12,pred13,pred14,pred15,pred16,pred17,pred18,pred19
        ...
        if len(deploy_ids) == 20:
            ...
            return pred1,pred2,pred3,pred4,pred5,pred6,pred7,pred8,pred9,pred10,pred11,pred12,pred13,pred14,pred15,pred16,pred17,pred18,pred19,pred20
        ...
        if len(deploy_ids) == 21:
            ...
            return pred1,pred2,pred3,pred4,pred5,pred6,pred7,pred8,pred9,pred10,pred11,pred12,pred13,pred14,pred15,pred16,pred17,pred18,pred19,pred20,pred21
        ...
        if len(deploy_ids) == 22:
            ...
            return pred1,pred2,pred3,pred4,pred5,pred6,pred7,pred8,pred9,pred10,pred11,pred12,pred13,pred14,pred15,pred16,pred17,pred18,pred19,pred20,pred21,pred22 
        ...
        if len(deploy_ids) == 23:
            ...
            return pred1,pred2,pred3,pred4,pred5,pred6,pred7,pred8,pred9,pred10,pred11,pred12,pred13,pred14,pred15,pred16,pred17,pred18,pred19,pred20,pred21,pred22,pred23    
        ...
        if len(deploy_ids) == 24:
            ...
            return pred1,pred2,pred3,pred4,pred5,pred6,pred7,pred8,pred9,pred10,pred11,pred12,pred13,pred14,pred15,pred16,pred17,pred18,pred19,pred20,pred21,pred22,pred23,pred24         
        ...
        if len(deploy_ids) == 25:
            ...
            return pred1,pred2,pred3,pred4,pred5,pred6,pred7,pred8,pred9,pred10,pred11,pred12,pred13,pred14,pred15,pred16,pred17,pred18,pred19,pred20,pred21,pred22,pred23,pred24,pred25
        ...
        if len(deploy_ids) == 26:
            ...
            return pred1,pred2,pred3,pred4,pred5,pred6,pred7,pred8,pred9,pred10,pred11,pred12,pred13,pred14,pred15,pred16,pred17,pred18,pred19,pred20,pred21,pred22,pred23,pred24,pred25,pred26
        ...
        if len(deploy_ids) == 27:
            ...
            return pred1,pred2,pred3,pred4,pred5,pred6,pred7,pred8,pred9,pred10,pred11,pred12,pred13,pred14,pred15,pred16,pred17,pred18,pred19,pred20,pred21,pred22,pred23,pred24,pred25,pred26,pred27        
        ...
        if len(deploy_ids) == 28:
            ...
            return pred1,pred2,pred3,pred4,pred5,pred6,pred7,pred8,pred9,pred10,pred11,pred12,pred13,pred14,pred15,pred16,pred17,pred18,pred19,pred20,pred21,pred22,pred23,pred24,pred25,pred26,pred27,pred28          
        ...
        if len(deploy_ids) == 29:
            ...
            return pred1,pred2,pred3,pred4,pred5,pred6,pred7,pred8,pred9,pred10,pred11,pred12,pred13,pred14,pred15,pred16,pred17,pred18,pred19,pred20,pred21,pred22,pred23,pred24,pred25,pred26,pred27,pred28,pred29         
        ...
        if len(deploy_ids) == 30:
            ...
            return pred1,pred2,pred3,pred4,pred5,pred6,pred7,pred8,pred9,pred10,pred11,pred12,pred13,pred14,pred15,pred16,pred17,pred18,pred19,pred20,pred21,pred22,pred23,pred24,pred25,pred26,pred27,pred28,pred29,pred30         
...
with tab1:     
    if os.path.isfile('config.csv'):
        ...
        feats_name = st.multiselect(
            'Select features to be simulated',
            feats, 
            feats,    
            key=1002
        )        
    
        st.markdown("<h1 style='text-align: center; color: grey;'>Simulated Features</h1>", unsafe_allow_html=True)
        feats_value_min = []
        feats_value_max = []
        for i in range(len(feats_name)):
            ...
            with col2:
                feat_value_min = st.number_input('min', step=0.01, format="%0.2f", value=df_feature[feats_name[i]].values.min(), key=i+400)  
                feats_value_min.append(feat_value_min)
            with col3:
                feat_value_max = st.number_input('max', step=0.01, format="%0.2f", value=df_feature[feats_name[i]].values.max(), key=i+500)   
                feats_value_max.append(feat_value_max)
                
        st.markdown("<h1 style='text-align: center; color: grey;'>Dropped Features</h1>", unsafe_allow_html=True)
        ...
        for i in range(len(feats_dropped)):
            ...
            with col2:
                feat_value_mean = st.number_input('mean', step=0.01, format="%0.2f", value=df_feature[feats_dropped[i]].values.mean(), key=i+600)  
                feats_value_mean.append(feat_value_mean)
                
        st.markdown("<h1 style='text-align: center; color: grey;'>Run Simulation</h1>", unsafe_allow_html=True)                
        col1, col2, col3 = st.columns(3)
...
#         with col3:
            if st.button('Simulation Start!', key=10003):  
                trial_all,trial_pareto = run_optimization(trials_num,df_feature,targets,deploy_ids,directions,feats_name+feats_dropped,feats_value_min+feats_value_mean,feats_value_max+feats_value_mean)
                trial_pareto['best_trial'] = 1
                trial_all = trial_all.merge(trial_pareto[['Iteration','best_trial']],on=['Iteration'],how='left')
...
with tab2:     
    if os.path.isfile('trial_all.csv'):
        ...
        for t in targets:
            fig = px.scatter(trial_all, x="Iteration", y=t,)
            fig.update_layout(
        ...
        trial_all_sort = trial_all.sort_values(['best_trial'],ascending=False).reset_index(drop=True)
